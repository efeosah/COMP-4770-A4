...
namespace C5
{
    ...
    public abstract class DictionaryBase<K, V> : CollectionValueBase<KeyValuePair<K, V>>, IDictionary<K, V>
    {
        ...
        {
            KeyValuePair<K, V> p = new KeyValuePair<K, V>(key, default);
        ...
        [Serializable]
        class LiftedEnumerable<H> : IEnumerable<KeyValuePair<K, V>> where H : K
        {
            readonly IEnumerable<H> keys;
        ...
        public virtual V this[K key]
        {
            get
            {
                ...
                throw new NoSuchItemException("Key '" + key! + "' not present in Dictionary");
            }
