...
namespace C5
{
    ...
    public abstract class SortedDictionaryBase<K, V> : DictionaryBase<K, V>, ISortedDictionary<K, V>
    {
        ...
        #endregion
        [Serializable]
        class KeyValuePairComparable : IComparable<SCG.KeyValuePair<K, V>>
        {
        ...
        [Serializable]
        class ProjectedDirectedEnumerable : MappedDirectedEnumerable<SCG.KeyValuePair<K, V>, K>
        {
        ...
        [Serializable]
        class ProjectedDirectedCollectionValue : MappedDirectedCollectionValue<SCG.KeyValuePair<K, V>, K>
        {
        ...
        class SortedKeysCollection : SequencedBase<K>, ISorted<K>
        {
            ...
            readonly ISorted<SCG.KeyValuePair<K, V>> sortedpairs;
